...
<form  name="login" action="JavaScript:form_submit(document.login, '7-2.default_session_login_action.jsp');">
		<table bgcolor="black" cellspacing="1" cellpadding="5" align="center">
			<tr>
				...
				<td bgcolor="white" width="170" align="center"><input type="text" size="20" name="id"></td>
			</tr>
			<tr>
				<th bgcolor="44ff44"><font size="2">비밀번호</font></th>
				<td bgcolor="white" width="170" align="center"><input type="password" size="20" name="pass"></td>
			</tr>
			<tr>
				<th colspan="2" bgcolor="ff8888">
					<input type="checkbox" name="savecookie" value="checked"><font size="2">ID저장</font>&nbsp;
					<input type="submit" value="로그인" class="TXTFLD">
				</th>
			</tr>
		</table>
	</form>
