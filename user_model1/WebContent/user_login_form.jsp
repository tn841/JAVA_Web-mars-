...
<%
	ArrayList<String> msgList = (ArrayList<String>)request.getAttribute("MSG");
	String idInput = (String)request.getAttribute("idInfo");
								...
								<table border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										...
										<td width=490 align="left" bgcolor="ffffff"
											...
											style="width: 150" name="userId" value="<%=idInput%>">&nbsp;&nbsp;<font color="red"><%=msg %></font></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">비밀번호</td>
										<td width=490 align="left" bgcolor="ffffff"
											style="padding-left: 10px"><input type="password"
											style="width: 150" name="password" value="">&nbsp;&nbsp;<font color="red"><%=passMSG %></font></td>
									</tr>
								</table>
							</form> <br />
							<table border="0" cellpadding="0" cellspacing="1">
