...
<%
	...
	if(rList.size()>0){
		out.println("<script>alert('예약정보가 있습니다. 마이페이지로 이동합니다.'); location.href='../User/user_modify_form.jsp'</script>");
	}
			...
			<div role="tabpanel" class="tab-pane active" id="15floor">
				...
				<div class="row">
					...
					<div class="col-md-4 well well-lg" id="info_div">
						...
						<ul>
							<li id="selected_seat">좌석 : </li>
							<li id="selected_date">날짜 : </li>
							<li id="selected_time">시간 :</li>
							<li id="selected_members">인원 : </li>
						</ul>
						<input type="button" value="예약하기" id="r_action"
...
<script>
	...
	function r_action_func() {
		seat_form.m_no.setAttribute("value",
<%=sUser.getM_no()%>
	);

		console.log("submit 실행");

		seat_form.action = "reservation_insert_action.jsp";
		seat_form.submit();
	}
</script>
