...
<%
	...
	System.out.println("requset 확인 : "+request);
	System.out.println("guest_no 확인 : "+guest_no);
	//System.out.println("수정 데이터 확인 : "+guest_name+" "+guest_email+" "+guest_homepage+" "+guest_title+" "+guest_content);
	
	GuestDao guestDao = new GuestDao();
	guest = guestDao.selectByNo(Integer.parseInt(guest_no));
%>
					...
					<tr>
						<td><br />
							...
							<table width=590 border=0 cellpadding=0 cellspacing=0>
								<tr>
									<td align=center><input type="button" value="수정"	onClick="guestModifyAction()"> &nbsp; <input
